    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(verbose_name='更新时间', auto_now=True)),
                ('is_delete', models.BooleanField(verbose_name='删除标记', default=False)),
                ('order_id', models.CharField(max_length=128, serialize=False, verbose_name='订单号', primary_key=True)),
                ...
                ('total_price', models.DecimalField(decimal_places=2, verbose_name='总金额', max_digits=10)),
                ('transit_price', models.DecimalField(decimal_places=2, verbose_name='运费', max_digits=10)),
